...
class RequestLog(Base):
    ...
    group_id_snapshot = Column(BigInteger, nullable=True, index=True)
    group_name_snapshot = Column(String(128), nullable=True)
    group_multiplier_snapshot = Column(DECIMAL(12, 6), nullable=True, default=1)
    ...
    bonus_quota_consumed = Column(DECIMAL(20, 6), nullable=True, default=0)
    ...
    cache_read_price_per_million_snapshot = Column(DECIMAL(12, 6), nullable=True, default=None)
...
class SubscriptionUsageCycle(Base):
    ...
    reserved_amount = Column(DECIMAL(20, 6), nullable=False, default=0)
