...
class UnifiedModel(Base):
    ...
    cache_read_price_per_million = Column(DECIMAL(12, 6), nullable=True, default=None, comment="Prompt cache read price per million tokens (USD); NULL uses 10% of input price")
