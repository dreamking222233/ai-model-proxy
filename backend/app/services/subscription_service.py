...
class SubscriptionService:
    ...
    def _serialize_consumption_record(record: ConsumptionRecord) -> dict:
        return {
            ...
            "cache_creation_cost": float(getattr(record, "cache_creation_cost", 0) or 0),
            ...
            "price_adjustment_source_snapshot": getattr(record, "price_adjustment_source_snapshot", None),
            "price_adjustment_rule_id_snapshot": getattr(record, "price_adjustment_rule_id_snapshot", None),
