...
CREATE TABLE `user_api_key` (
    ...
    `total_cost` DECIMAL(20, 6) NOT NULL DEFAULT 0 COMMENT '总消费金额(USD)',
...
CREATE TABLE `channel` (
    ...
    `provider_variant` VARCHAR(32) NOT NULL DEFAULT 'default' COMMENT '渠道子类型: default/openai-image-compatible/openai-image-native-size/openai-image-modelinvoke/geek2api-image/cpa-grok-video/grok-video-119337/zz1cc-video/grok-imagine/google-official/google-vertex-image',
