...
CREATE TABLE `channel` (
    ...
    `provider_variant` VARCHAR(32) NOT NULL DEFAULT 'default' COMMENT 'Provider subtype: default/openai-image-compatible/openai-image-native-size/openai-image-modelinvoke/cpa-grok-video/google-official/google-vertex-image',
