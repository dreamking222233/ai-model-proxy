...
CREATE TABLE `agent` (
    ...
    `custom_recharge_rate` DECIMAL(12, 6) NOT NULL DEFAULT 5 COMMENT '代理站用户统一充值比例',
...
CREATE TABLE `user_api_key` (
    ...
    `total_cost` DECIMAL(20, 6) NOT NULL DEFAULT 0 COMMENT '总消费(美元)',
...
CREATE TABLE `channel` (
    ...
    `provider_variant` VARCHAR(32) NOT NULL DEFAULT 'default' COMMENT 'Provider subtype: default/openai-image-compatible/openai-image-native-size/openai-image-modelinvoke/geek2api-image/cpa-grok-video/zz1cc-video/google-official/google-vertex-image',
...
-- ============================================================
-- 4.2 model_price_adjustment_rule - 模型分类价格调控规则表
-- ============================================================
...
-- ============================================================
-- 4.3 user_price_adjustment_rule - 用户专属模型价格调控规则表
-- ============================================================
...
-- ============================================================
-- 4.4 video_task_billing_snapshot - 异步视频任务计费快照表
-- ============================================================
...
-- ============================================================
-- 9.1 platform_announcement - 平台公告表
-- ============================================================
...
CREATE TABLE `payment_recharge_order` (
    ...
    `user_recharge_rate` DECIMAL(12, 6) NOT NULL DEFAULT 0 COMMENT '下单时实际用户充值比例快照',
...
-- ============================================================
-- 14.2 user_promotion_relation - 用户推广绑定关系表
-- ============================================================
...
-- ============================================================
-- 14.3 user_promotion_reward - 用户推广充值返现记录表
-- ============================================================
