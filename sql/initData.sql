...
CREATE TABLE `agent` (
    ...
    `online_recharge_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '代理站在线充值开关 1=开启 0=关闭',
...
-- ============================================================
-- 12.1 payment_recharge_order - 在线充值订单表
-- ============================================================
...
-- ============================================================
-- 12.2 agent_cash_balance - 代理人民币现金余额表
-- ============================================================
...
-- ============================================================
-- 12.3 agent_cash_ledger - 代理人民币现金流水表
-- ============================================================
...
-- ============================================================
-- 12.4 agent_cash_withdrawal - 代理现金提现记录表
-- ============================================================
